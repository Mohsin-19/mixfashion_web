...
class Item extends Cl_Controller
{
    ...
    if ($this->input->post('submit')) {
      ...
      if ($validate) {
        ...
        if ($id == '') {
          ...
          if (isset($galary_image_1) && $galary_image_1) {
            $product_info['galary_image_1'] = $galary_image_1;
          } else {
        ...
        if ($id == '') {
          ...
          $galary_image_2_old = $this->input->post('galary_image_1_old');
          if (isset($galary_image_2) && $galary_image_2) {
            $product_info['galary_image_2'] = $galary_image_2;
          } else {
        ...
        if ($id == '') {
          ...
          if (isset($galary_image_3) && $galary_image_3) {
            $product_info['galary_image_3'] = $galary_image_3;
          } else {
        ...
        if ($id == '') {
          ...
          if (isset($galary_image_4) && $galary_image_4) {
            $product_info['galary_image_4'] = $galary_image_4;
          } else {
  ...
  public function validateProducts($id = '')
  {
    ...
    $this->form_validation->set_rules('name', lang('name'), 'required|max_length[100]' . $is_unique);
    ...
    $this->form_validation->set_rules('description', lang('description'), 'max_length[12]');
    ...
    $details_modal_image_old = $this->input->post('details_modal_image_old');
    if ($has_offer == "Yes") {
      $this->form_validation->set_rules('offer', lang('offer'), 'required|max_length[200]');
    ...
    // for galary_image_1
    $galary_image_1_old = $this->input->post('galary_image_1_old');
    // $this->form_validation->set_rules('galary_image_1', lang('offer'), 'required|max_length[200]');
    ...
    // $this->form_validation->set_rules('galary_image_2', lang('offer'), 'required|max_length[200]');
    ...
    // for galary_image_3
    $galary_image_3_old = $this->input->post('galary_image_3_old');
    // $this->form_validation->set_rules('galary_image_3', lang('offer'), 'required|max_length[200]');
    ...
    // for galary_image_4
    $galary_image_4_old = $this->input->post('galary_image_4_old');
    // $this->form_validation->set_rules('galary_image_4', lang('offer'), 'required|max_length[200]');
  ...
  {
    return true;
    $txt = htmlspecialchars($this->input->post('name'));
    if (!preg_match('/^[a-zA-Z0-9\s]+$/', $txt)) {
      $this->form_validation->set_message('name', 'The field may only contain alpha characters & number');
      return FALSE;
    } else {
      return true;
    }
  ...
  /**
   * check name_for_your validation
   * @access public
   * @return boolean
   */
  public function name_for_your()
  {
    return true;
    $txt = htmlspecialchars($this->input->post('name_for_your'));
    if (!preg_match('/^[a-zA-Z0-9\s]+$/', $txt)) {
      $this->form_validation->set_message('name_for_your', 'The field may only contain alpha characters & number');
      return FALSE;
    } else {
      return true;
    }
  ...
  /**
   * check name_for_people validation
   * @access public
   * @return boolean
   */
  public function name_for_people()
  {
    return true;
    $txt = htmlspecialchars($this->input->post('name_for_people'));
    if (!preg_match('/^[a-zA-Z0-9\s]+$/', $txt)) {
      $this->form_validation->set_message('name_for_people', 'The field may only contain alpha characters & number');
      return FALSE;
    } else {
      return true;
    }
  ...
  public function validate_details_modal_image()
  {
    if ($_FILES['details_modal_image']['name'] != "") {
      ...
      $this->form_validation->set_message('validate_details_modal_image', lang('img_select_error_msg'));
      return FALSE;
    }
  }
  ...
  public function validate_galary_image_1()
  {
    if ($_FILES['galary_image_1']['name'] != "") {
      ...
      if ($this->upload->do_upload("galary_image_1")) {
        ...
        $config['image_library'] = 'gd2';
        $config['source_image'] = './images/gallery/' . $photo;
        $config['maintain_ratio'] = FALSE;
        // $config['width'] = 563;
        // $config['height'] = 564;
            ...
            for ($i = 4; $i <= $totalrows; $i++) {
              ...
              /*
                              if(!preg_match('/^[a-zA-Z0-9\s]+$/', $name)){
                                  if ($arrayerror == '') {
                                      $arrayerror.=" Row Number $i column A may only contain alpha characters & number";
                                  } else {
                                      $arrayerror.="<br> Row Number $i column A may only contain alpha characters & number";
                                  }
                              }*/
