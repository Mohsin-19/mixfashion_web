...
class Sslcommerz
{
  ...
  public function __construct()
  {
    ...
    $this->setSSLCommerzMode(($paymentSetting) && $paymentSetting->field_4_v == 1 ? $paymentSetting->field_4_v : 0);
    $this->store_id = $paymentSetting->field_4_key_1;
    $this->store_pass = $paymentSetting->field_4_key_2;
  ...
  public function RequestToSSLC($post_data, $storeid, $storepass, $order_id)
  {
    $handle = curl_init();
