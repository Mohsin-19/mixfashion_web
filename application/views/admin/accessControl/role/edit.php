    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><?= lang('edit_role'); ?></h3>
        </div> <!-- /.box-header -->

        <?= form_open("admin/role/{$role->id}/update", ['role' => 'form']); ?>

        <div class="box-body">

          <div class="form-group">
            <label for="name"> Role name <span class="required_star">*</span> :</label>
            <?= form_input(['name' => 'name', 'value' => $role->name, 'id' => 'name', 'class' => 'form-control', 'placeholder' => 'name']) ?>
          ...
          <div class="form-group">
            ...
            <?= form_textarea(['name' => 'description', 'value' => $role->description, 'id' => 'description', 'class' => 'form-control', 'placeholder' => 'description', 'rows' => 3]) ?>
