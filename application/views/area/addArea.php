  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        echo form_open_multipart(base_url('area/addEditArea/'), $attributes); ?>
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input tabindex="1" autocomplete="off" type="number" name="delivery_charge" class="form-control"
                       placeholder="<?= lang('DeliveryCharge'); ?>" value="<?php echo set_value('delivery_charge'); ?>">
              </div>
