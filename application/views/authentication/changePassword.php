                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> 
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="password" name="old_password" class="form-control" placeholder="<?php echo lang('old_password'); ?>">
                            </div>
                        ...
                        <div class="col-md-6">  
                            <div class="form-group">
                                ...
                                <input tabindex="2" autocomplete="off" type="password" name="new_password" class="form-control" placeholder="<?php echo lang('new_password'); ?>">
                            </div>
