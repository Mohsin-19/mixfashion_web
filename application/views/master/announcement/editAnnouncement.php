  ...
  <div class="row" style="justify-content: center!important;display: flex;">
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open_multipart('Announcement/addEditAnnouncement/' . $encrypted_id, ['class' => 'form-horizontal']); ?>
        <div class="box-body">
              ...
              <div class="checkbox">
                <label>
                  <?php echo form_checkbox([
                    ...
                    'checked' => $announcement->active ? true : false
                  ]) ?> Active
                </label>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8 form-group">
              <label class="radio-inline">
                <input type="radio" name="upload_type" id="text" value="text" class="upload_type" <?= $announcement->upload_type == 'text' ? 'checked="checked"' : '' ?>> Normal Text
              </label>
              <label class="radio-inline">
                <input type="radio" name="upload_type" id="img" value="img" class="upload_type" <?= $announcement->upload_type == 'img' ? 'checked="checked"' : '' ?>> Image
              </label>
              <label class="radio-inline">
                <input type="radio" name="upload_type" id="yt" value="yt" class="upload_type" <?= $announcement->upload_type == 'yt' ? 'checked="checked"' : '' ?>> YouTube Video
              </label>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              echo form_upload([
                ...
                'style' => $announcement->upload_type == 'img' ?: 'display:none',
              ]);
              echo form_input([
                'name' => 'upload_content',
                'id' => 'upload_content',
                ...
                'value' => $announcement->upload_content,
                'style' => $announcement->upload_type == 'img' ? 'display:none' : '',
              ]) ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <?php echo form_input([
                ...
                'autocomplete' => 'off',
                'value' => date('Y-m-d', strtotime($announcement->end_date)),
              ]) ?>
            </div>
