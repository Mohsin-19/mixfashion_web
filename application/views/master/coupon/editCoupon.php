  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- /.box-header -->
        <!-- form start -->
        <?php echo form_open(base_url('Coupon/addEditCoupon/' . $encrypted_id)); ?>
        <div class="box-body">
          <div class="row">
            <div class="col-md-3">

              <div class="form-group">
                <label><?php echo lang('code'); ?> <span class="required_star">*</span> </label><a style="float: right" class="btn btn-xs btn-primary generate_now pull-right"><?php echo lang('Generate'); ?></a>
                <input tabindex="1" autocomplete="off" type="text" id="code" name="code" class="form-control" placeholder="<?php echo lang('code'); ?>" value="<?php echo $coupon->code ?>">
              </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                echo form_dropdown('coupon_option', $options, $coupon->coupon_option, ['id' => 'coupon_option', 'class' => 'form-control select2']);
                ?>
              </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                echo form_dropdown('amount', $options, $coupon->amount, ['id' => 'amount', 'class' => 'form-control select2']);
                ?>
              </div>
            ...
            <div class="col-md-3">
              ...
              <div class="form-group">
                ...
                <input tabindex="1" autocomplete="off" type="text" name="expired_date" class="form-control customDatepickerCustom1" placeholder="<?php echo lang('expired_date'); ?>" value="<?php echo $coupon->expired_date ?>">
              </div>
        ...
        <div class="box-footer">
          ...
          <a href="<?php echo base_url() ?>Coupon/coupons"><button type="button" class="btn btn-primary"><?php echo lang('back'); ?></button></a>
        </div>
        <?php echo form_close(); ?>
      </div>
    </div>
