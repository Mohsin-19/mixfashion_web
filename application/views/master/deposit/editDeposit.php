<section class="content-header">
    <h1>
        <?php echo lang('edit').' '. lang('deposit_or_withdraw'); ?>
    </h1>
</section>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="text" id="reference_no" readonly name="reference_no" class="form-control" placeholder="<?php echo lang('ref_no'); ?>" value="<?php echo escape_output($deposit_information->reference_no); ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="3" autocomplete="off" readonly type="text" id="date" name="date" class="form-control" placeholder="<?php echo lang('date'); ?>" value="<?php echo date('Y-m-d', strtotime($deposit_information->date)); ?>">
                            </div>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="3" autocomplete="off"  type="text" id="amount" name="amount" class="form-control integerchk" placeholder="<?php echo lang('amount'); ?>" value="<?php echo escape_output($deposit_information->amount); ?>">
                            </div>
                    ...
                    <div class="row">
						 ...
						 <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="4" class="form-control select2 select2-hidden-accessible width_100_p" name="type" id="type">
									...
									<option <?php echo set_select('type', "Deposit"); ?>  <?php if($deposit_information->type=="Deposit") echo "Selected"; ?> value="Deposit"><?php echo lang('Deposit'); ?></option>
									<option <?php echo set_select('type', "Withdraw"); ?> <?php if($deposit_information->type=="Withdraw") echo "Selected"; ?> value="Withdraw"><?php echo lang('Withdraw'); ?></option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea tabindex="3" class="form-control" rows="2" id="note" name="note" placeholder="<?php echo lang('Enter...'); ?>"><?php echo escape_output($deposit_information->note); ?></textarea>
                            </div>
