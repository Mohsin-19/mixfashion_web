<section class="content-header">
    <h1>
        <?php echo lang('add_expense_product'); ?>
    </h1>  
</section>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" autocomplete="off" type="text" name="name" class="form-control" placeholder="<?php echo lang('expense_product_name'); ?>" value="<?php echo set_value('name'); ?>">
                            </div>
