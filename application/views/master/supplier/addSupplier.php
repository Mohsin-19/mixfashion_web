                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="2" autocomplete="off" type="text" name="contact_person" class="form-control" placeholder="<?php echo lang('contact_person'); ?>" value="<?php echo set_value('contact_person'); ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input tabindex="5" autocomplete="off" type="text" id="previous_due" name="previous_due" class="form-control " placeholder="<?php echo lang('previous_due'); ?>" value="">
                            </div>

                            <div class="form-group">
                                <label><?php echo lang('address'); ?></label>
                                <textarea tabindex="6" class="form-control" rows="3" name="address" placeholder="<?php echo lang('address'); ?>"><?php echo escape_output($this->input->post('address')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label><?php echo lang('description'); ?></label>
                                <textarea tabindex="7" class="form-control" rows="3" name="description" placeholder="<?php echo lang('enter'); ?> ..."><?php echo escape_output($this->input->post('description')); ?></textarea>
                            </div> 
