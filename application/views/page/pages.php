    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body table-responsive">
          <input type="hidden" class="datatable_name" data-title="<?php echo lang('Pages'); ?>" data-id_name="datatable">
          <table id="datatable" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th class="width_1_p"><?php echo lang('sn'); ?></th>
                <th class="width_23_px"><?php echo lang('MenuName'); ?></th>
                <th class="width_2_px c_center not-export-col"><?php echo lang('actions'); ?></th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo escape_output($usrs->menu_name); ?></td>
                  <th class="c_center">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        <li>
                          <a href="<?php echo base_url() ?>page/addEditPage/<?php echo escape_output($this->custom->encrypt_decrypt($usrs->id, 'encrypt')); ?>"><i class="fa fa-edit"></i><?php echo lang('edit'); ?></a>
                        </li>
                        <?php
                        if ($usrs->id != 10) :
                        ?>
                          <li>
                            <a class="delete" href="<?php echo base_url() ?>page/deletePage/<?php echo escape_output($this->custom->encrypt_decrypt($usrs->id, 'encrypt')); ?>"><i class="fa fa-trash tiny-icon"></i><?php echo lang('delete'); ?></a>
                          </li>
                        <?php
                        endif;
                        ?>
