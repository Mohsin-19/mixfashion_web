<section class="content-header">
    <h3  class="txt-uh-83"><?php echo lang('damage_report'); ?></h3>
    <hr class="txt-uh-83">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            ...
            <div class="form-group">
                <select tabindex="2" class="form-control select2 width_100_p" id="user_id" name="user_id">
                    <option value=""><?php echo lang('user'); ?></option>
                    <option value="<?php echo escape_output($this->session->userdata['user_id']); ?>"><?php echo escape_output($this->session->userdata['full_name']); ?></option>
                    <?php
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <h3 class="c_center"><?php echo lang('damage_report'); ?></h3>
                    ...
                    if (isset($user_id) && $user_id):
                        echo lang('user').": <span class='txt-uh-84'>" . userName($user_id) . "</span>";
                    else:
                        echo lang('user').": ".lang('all');
                    endif;
                    ?></h4>
                    <br><input type="hidden" class="datatable_name" data-title="<?php echo lang('damage_report'); ?>" data-id_name="datatable">
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th class="width_1_p"><?php echo lang('sn'); ?></th>
                                <th class="width_11_p"><?php echo lang('reference_no'); ?></th>
                        ...
                        <tbody>
                            ...
                            if (isset($damageReport)):
                                foreach ($damageReport as $key => $value) {
                                    ...
                                    $key++;
                                    $countTotal+=productCount($value->id);
                                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo productCount($value->id); ?></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><?php echo escape_output($countTotal) ?></th>
                                <th></th>
                            </tr>
                        </tfoot>
                    </table>
