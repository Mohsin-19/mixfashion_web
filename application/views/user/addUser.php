    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <input tabindex="1" autocomplete="off" type="text" name="full_name" class="form-control"
                       placeholder="<?php echo lang('name'); ?>" value="<?php echo set_value('full_name'); ?>">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <input tabindex="2" autocomplete="off" type="text" name="email_address" class="form-control"
                       placeholder="<?php echo lang('email_address'); ?>" value="<?php echo set_value('email_address'); ?>">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <input tabindex="3" autocomplete="off" type="text" name="phone" class="form-control integerchk"
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input tabindex="4" autocomplete="off" type="text" name="designation" class="form-control"
                       placeholder="<?php echo lang('designation'); ?>" value="<?php echo set_value('designation'); ?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input tabindex="4" autocomplete="off" type="text" name="commission" class="form-control"
                       placeholder="<?php echo lang('commission'); ?>" value="<?php echo set_value('commission'); ?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input tabindex="5" autocomplete="off" type="text" name="salary" class="form-control"
                       placeholder="<?php echo lang('salary'); ?>" value="<?php echo set_value('salary'); ?>">
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label> &nbsp; </label><br>
                <button id="view_photo" type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#view_photo_modal"><?php echo lang('view_photo'); ?></button>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label><input type="checkbox" name="is_delivery_person" value="Delivery Person"><?php echo lang('ThisisDeliveryPerson'); ?>
                </label>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="form-group radio_button_problem">
                ...
                <div class="radio">
                  <label>
                    <input tabindex="5" autocomplete="off" type="radio" name="will_login" id="will_login_yes"
                           value="Yes"><?php echo lang('Yes'); ?> </label>
                  <label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input tabindex="5" autocomplete="off" type="radio" name="will_login" id="will_login_no" value="No"
          ...
          <div id="will_login_section" class="display_none">
            <div class="row">
              <div class="col-md-4">

                <div class="form-group">
                  <label><?php echo lang('password'); ?> <span class="required_star">*</span></label>
                  <input tabindex="5" autocomplete="off" type="text" name="password" class="form-control"
                         placeholder="<?php echo lang('password'); ?>" value="<?php echo set_value('password'); ?>">
                </div>
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <input tabindex="4" autocomplete="off" type="text" name="confirm_password" class="form-control"
                         placeholder="<?php echo lang('confirm_password'); ?>" value="<?php echo set_value('confirm_password'); ?>">
                </div>
              ...
              foreach ($access_modules as $keys => $value) {
                ...
                <div class="col-sm-12">
                  <label class="container txt-uh-73"><?php echo "<b>" . $value->label_name . "</b>" ?>
                    <input class="checkbox_user_p  parent_class parent_class_<?php echo str_replace(' ', '_', $value->module_name) ?>"
                           data-name="<?php echo str_replace(' ', '_', $value->module_name) ?>" type="checkbox">
                    <span class="checkmark"></span>
                  </label>
                  ...
                  <div class="col-md-<?php echo escape_output($value_f->label_name) == "Change Password" ? '3' : '2' ?>">
                    <label class="container txt-uh-77"><?php echo escape_output($value_f->label_name); ?>
                      <input type="checkbox" <?php echo escape_output($checked) ?>
                             class="checkbox_user child_class child_<?php echo str_replace(' ', '_', $value->module_name) ?>"
