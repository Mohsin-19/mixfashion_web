$(function () {
      ...
      function () {
        ...
        $.ajax({
          ...
          beforeSend: function name(params) {
            $("#change_status_add").prop("disabled", true);
          },
          success: function (data) {
            ...
            $("#change_status_add").prop("disabled", false);
          },
          error: function () {
  ...
  $(document)
    .on("submit", "#quickOrderEditForm", function (e) {
      e.preventDefault();
      var column = $(document);
      var order_edit_modal = $(document).find("#order_edit_modal");
      ...
      $.ajax({
        ...
        success: function (htmlData) {
          ...
          column
            .find(".delivery-date-" + htmlData.id)
            .text(htmlData.delivery_date);
          column
            .find(".delivery-time-" + htmlData.id)
            .text(htmlData.delivery_time);
          column
            .find(".checkout-name-" + htmlData.id)
            .text(htmlData.checkout_name);
