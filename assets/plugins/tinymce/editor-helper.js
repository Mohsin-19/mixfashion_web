function default_editor(selector, height = 250) {
  tinymce.init({
    menubar: false,
    branding: false,
    selector: selector,
    height: height,
    plugins: ["wordcount lists link code importcss hr"],
    toolbar:
      "bold italic underline  | removeformat | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent| hr  code ",
